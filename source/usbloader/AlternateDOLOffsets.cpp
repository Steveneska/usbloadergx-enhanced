...
void defaultDolPrompt(const char *gameid)
{
	...
	{
		int choice = WindowPrompt(tr("Select DOL" ), 0, "Metroid Prime", "Metroid Prime 2", "Metroid Prime 3", tr("Open List"));
		if(choice == 1)
...
int autoSelectDolPrompt(const char *gameid)
{
	...
	{
		int choice = WindowPrompt(tr("Select DOL" ), 0, "Fate of Atlantis", tr("Open List"), tr("Cancel"));
		if(choice == 1)
	...
	{
		int choice = WindowPrompt(tr("Select DOL" ), 0, "Metal Slug 6", tr("Open List"), tr("Cancel"));
		if(choice == 1)
			return 54;
		else if(choice == 0)
			return 0;
	...
	{
		int choice = WindowPrompt(tr("Select DOL" ), 0, "Rampage", "World Tour", tr("Open List"), tr("Cancel"));
		if(choice == 1)
			return 369;
	...
	{
		int choice = WindowPrompt(tr("Select DOL" ), 0, "HotD 2", tr("Open List"), tr("Cancel"));
		if(choice == 1)
			return 149;
		else if(choice == 2)
			return 0;
	...
	{
		int choice = WindowPrompt(tr("Select DOL" ), 0, tr("Motion+ Video"), tr("Open List"), tr("Cancel"));
		if(choice == 1)
