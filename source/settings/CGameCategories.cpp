...
bool CGameCategories::Save()
{
	...
	StartProgress(tr("Library Manager"), tr("Generating categories file. Please wait"), 0, false, true);
	...
	ShowProgress(tr("Library Manager"), tr("Saving categories file. Please wait"), 0, progressSize, progressSize, false, true);
...
bool CGameCategories::ImportFromGameTDB(const std::string &xmlpath)
{
	...
	StartProgress(tr("Library Manager"), tr("Importing categories. Please wait"), 0, false, true);
